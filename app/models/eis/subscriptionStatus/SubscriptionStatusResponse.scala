...
package models.eis.subscriptionStatus

import play.api.libs.json.{Json, OFormat}
import models.eis.subscriptionStatus.ETMPSubscriptionStatus.{NO_FORM_BUNDLE_FOUND, SUCCESSFUL}
import models.eis.subscriptionStatus.SubscriptionStatus.{
  NOT_SUBSCRIBED,
  SUBSCRIBED,
  Status,
  UNKNOWN
